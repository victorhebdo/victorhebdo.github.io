...
array.each { |i| @client.follow(i) }


puts array[0..3]

#client.follow('eli_sparow')


#client.follow('nike_jean')  # Fonctionne
#client.follow("SEEYOULHATER") #Fonctionne
...
def jb #proposition marriage Justin Bieber
...
client.update('2eme') #fonctionne


topics = ["coffee", "tea"]
client2.filter(track: topics.join(",")) do |object|  # Fonctionne
  puts object.text if object.is_a?(Twitter::Tweet)   # Fonctionne
end
